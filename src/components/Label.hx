...
{
	private var font:TextFormat = new TextFormat(Assets.getFont("fonts/Verdana.ttf").fontName, 14, 0xFFFFFF, null, null, null, null, null, TextFormatAlign.LEFT);
	...
	public function new(_type:Int = LabelType.DYNAMIC, _msg:String = "", _width:Int = 255, _height:Int = 30) 
	{
		...
		if (_type == LabelType.INPUT) font.color = 0;
	...
	public function render() {
		...
		this.graphics.lineTo(tWidth + 3, 0);
		this.graphics.lineTo(tWidth + 3, tHeight);
		this.graphics.lineTo(0, tHeight);
		this.graphics.lineTo(0, 0);
	}
	private function send_event(e:Event) {
